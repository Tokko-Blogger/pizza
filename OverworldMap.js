...
window.OverworldMaps = {
  DemoRoom: {
    id: "DemoRoom",
    lowerSrc: "/pizza/images/maps/DemoLower.png",
    upperSrc: "/pizza/images/maps/DemoUpper.png",
    configObjects: {
      hero: {
        type: "Person",
      ...
      npcA: {
        ...
        x: utils.withGrid(10),
        y: utils.withGrid(8),
        src: "/pizza/images/characters/people/npc1.png",
        behaviorLoop: [
      ...
      npcB: {
        ...
        x: utils.withGrid(8),
        y: utils.withGrid(5),
        src: "/pizza/images/characters/people/erio.png",
        talking: [
          {
            events: [
  ...
  Kitchen: {
    id: "Kitchen",
    lowerSrc: "/pizza/images/maps/KitchenLower.png",
    upperSrc: "/pizza/images/maps/KitchenUpper.png",
    configObjects: {
      hero: {
        type: "Person",
        isPlayerControlled: true,
      ...
      kitchenNpcA: {
        ...
        y: utils.withGrid(5),
        direction: "up",
        src: "/pizza/images/characters/people/npc8.png",
        talking: [
          {
            events: [
      ...
      kitchenNpcB: {
        ...
        x: utils.withGrid(3),
        y: utils.withGrid(6),
        src: "/pizza/images/characters/people/npc3.png",
        talking: [
          {
            events: [
  ...
  Street: {
    id: "Street",
    lowerSrc: "/pizza/images/maps/StreetLower.png",
    upperSrc: "/pizza/images/maps/StreetUpper.png",
    configObjects: {
      hero: {
        type: "Person",
        isPlayerControlled: true,
      ...
      streetNpcA: {
        ...
        x: utils.withGrid(9),
        y: utils.withGrid(11),
        src: "/pizza/images/characters/people/npc2.png",
        behaviorLoop: [
      ...
      streetNpcB: {
        ...
        x: utils.withGrid(31),
        y: utils.withGrid(12),
        src: "/pizza/images/characters/people/npc7.png",
        behaviorLoop: [
          { type: "stand", direction: "up", time: 400, },
  ...
  Shop: {
    id: "Shop",
    lowerSrc: "/pizza/images/maps/PizzaShopLower.png",
    upperSrc: "/pizza/images/maps/PizzaShopUpper.png",
    configObjects: {
      hero: {
        type: "Person",
        isPlayerControlled: true,
  ...
  GreenKitchen: {
    id: "GreenKitchen",
    lowerSrc: "/pizza/images/maps/GreenKitchenLower.png",
    upperSrc: "/pizza/images/maps/GreenKitchenUpper.png",
    configObjects: {
      hero: {
        type: "Person",
        isPlayerControlled: true,
      ...
      greenKitchenNpcC: {
        ...
        x: utils.withGrid(3),
        y: utils.withGrid(5),
        src: "/pizza/images/characters/people/secondBoss.png",
        talking: [
          {
            required: ["chefRootie"],
  ...
  StreetNorth: {
    id: "StreetNorth",
    lowerSrc: "/pizza/images/maps/StreetNorthLower.png",
    upperSrc: "/pizza/images/maps/StreetNorthUpper.png",
    configObjects: {
      hero: {
        type: "Person",
        isPlayerControlled: true,
  ...
  DiningRoom: {
    id: "DiningRoom",
    lowerSrc: "/pizza/images/maps/DiningRoomLower.png",
    upperSrc: "/pizza/images/maps/DiningRoomUpper.png",
    configObjects: {
      hero: {
        type: "Person",
        isPlayerControlled: true,
      ...
      diningRoomNpcB: {
        ...
        x: utils.withGrid(9),
        y: utils.withGrid(5),
        src: "/pizza/images/characters/people/npc4.png",
        talking: [
          {
            events: [
